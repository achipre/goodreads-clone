  ...
  return (
    <motion.main initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }} className="flex justify-center mt-16">
      <section className="flex flex-col items-center px-3 w-full max-w-md min-w-[288px]">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="gap-2 max-w-md w-full">
          <div className="my-6">
          ...
          <div className="flex gap-4 flex-col">
            <InputPrimary { ...register('fullname') } className='pl-10 w-full' type='text' placeholder='Full Name' icon={<IconUser className='absolute p-[2px] top-0 translate-y-1/2 ml-2 stroke-millbrook-900 pointer-events-none' />}/>
