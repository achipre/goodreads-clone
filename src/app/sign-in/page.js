    ...
    <motion.main initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 1}} className="flex justify-center mt-16">
      <section className="flex flex-col items-center px-3 w-full max-w-md min-w-[288px]">
        ...
        <form className="flex flex-col my-6 w-full">
          <InputPrimary className='mb-4 pl-10 w-full' type='email' placeholder={'Email'} icon={<IconEmail className='absolute p-[2px] top-0 translate-y-1/2 ml-2 fill-millbrook-900 pointer-events-none' />} />
          ...
          <ButtonPrimary className='mt-8 py-[10px]'>Sign In</ButtonPrimary>
        </form>
